# Notas de Revisão por Capítulo

> O agente revisor anexa aqui um resumo por capítulo revisado. Não apagar
> histórico — isso é o log de evolução da qualidade do texto.

## Capítulo 1 — "O Trabalho" / "Sala de Espera Cheia" (Livro 1)
**Data da revisão:** 2026-08-27

**Resumo:** Capítulo de abertura consistente com a bíblia na maior parte —
nomenclatura das presenças, origem do Poço/Credor, regra de sobrecarga da
Sala de Espera e linha vermelha de Íris todas batem com `personagens.md` e
`sistema-de-poderes.md`. Tema tratado sem clichê (nenhuma menção a
"loucura", ambiguidade real das presenças preservada, agência de Íris
mantida no clímax).

**Pontos de atenção levantados e resolução:**
1. Prosa: construção repetida "como se X" (4x) e uma frase longa que
   somava ritmo arrastado + explicação excessiva do mecanismo
   psicológico. **Resolvido** — variadas duas ocorrências de "como se" e
   cortada/reescrita a frase mais longa.
2. Tema: três trechos verbalizavam a linha vermelha de forma quase
